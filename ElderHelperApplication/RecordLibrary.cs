...
public class RecordLibrary
{
    ...
    public async Task Play(CoreDispatcher dispatcher)
    {
        ...
        StorageFolder storageFolder = await KnownFolders.MusicLibrary.CreateFolderAsync("Recorded Folder", CreationCollisionOption.OpenIfExists);
        ...
        {
            storageFile = await storageFolder.CreateFileAsync(audioFilename, CreationCollisionOption.GenerateUniqueName);
